...
""")
    if st.button("Ir para UMAP Explorer"):
        st.experimental_set_query_params(page="umap")
...
""")
    if st.button("Ir para Calculadora APGAR 5"):
        st.experimental_set_query_params(page="apgar")

# -----------------------------
# Rodapé
# -----------------------------
st.markdown("---")
st.markdown("💡 Use o menu lateral para navegar entre as páginas do app ou os botões acima.")
